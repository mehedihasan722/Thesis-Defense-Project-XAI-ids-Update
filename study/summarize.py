...
def main():
    ...
    lines.extend(['','[Across-seed analysis](ACROSS_SEEDS.md) · [RQ3 analysis](xai/ANALYSIS.md) · [Calibration](calibration/ANALYSIS.md) · [Imbalance](imbalance/ANALYSIS.md) · [Figure index](figures/FIGURES.md)',''])
    previous=(out/'RESULTS.md').read_text(encoding='utf-8') if (out/'RESULTS.md').exists() else ''
    figures='<!-- generated-figures -->'+previous.split('<!-- generated-figures -->',1)[1] if '<!-- generated-figures -->' in previous else ''
