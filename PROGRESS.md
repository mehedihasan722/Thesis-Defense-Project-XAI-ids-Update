...
Results, tables and embedded figures are in results/study/RESULTS.md, ACROSS_SEEDS.md and the xai/, llm/, calibration/, imbalance/ and shift/ analysis files. The thesis report has been revised from the completed evidence. See [revision notes](docs/THESIS_REVISION.md), [PDF](output/pdf/thesis_xai_ids.pdf) and [editable manuscript](thesis/manuscript.md). Author signatures and supervisor review remain human tasks.
