...
- Four new framework tests pass, covering splitting, sampling, neural inference/serialization and metrics.
- Fresh training and LLM evaluation are in progress; no completed comparative conclusion or updated thesis PDF is claimed yet.
